...
mkdir -p /home/xtreamcodes/
tar -xf "/tmp/xtreamcodes.tar.xz" -C "/home/xtreamcodes/"
chattr -i /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb >/dev/null 2>&1
...
tar -xf phpbuild-php7.2-Ubuntu-$LTS.tar.xz
...
wget --no-check-certificate -qO /home/xtreamcodes/phpbuild/ioncube_loaders_lin_x86-64.tar.gz https://downloads.ioncube.com/loader_downloads/ioncube_loaders_lin_x86-64.tar.gz
tar -xf /home/xtreamcodes/phpbuild/ioncube_loaders_lin_x86-64.tar.gz >/dev/null 2>&1
cp ioncube/ioncube_loader_lin_7.2.so /home/xtreamcodes/iptv_xtream_codes/php/lib/php/extensions/no-debug-non-zts-20170718/
wget --no-check-certificate -qO /tmp/update.zip "https://github.com/jua74470/odiniptvpanelfreesourcecode/releases/download/download/update_original.zip" >/dev/null 2>&1
unzip /tmp/update.zip -d /tmp/update/ >/dev/null 2>&1
cp -rf /tmp/update/XtreamUI-master/* /home/xtreamcodes/iptv_xtream_codes/ >/dev/null 2>&1
rm -rf /tmp/update/XtreamUI-master >/dev/null 2>&1
rm /tmp/update.zip >/dev/null 2>&1
rm -rf /tmp/update >/dev/null 2>&1
rm -f /home/xtreamcodes/iptv_xtream_codes/bin/ffmpeg >/dev/null 2>&1
rm -f /home/xtreamcodes/iptv_xtream_codes/bin/ffprobe >/dev/null 2>&1
ln -s /home/xtreamcodes/iptv_xtream_codes/bin/ffmpeg_2018 /home/xtreamcodes/iptv_xtream_codes/bin/ffmpeg >/dev/null 2>&1
ln -s /home/xtreamcodes/iptv_xtream_codes/bin/ffprobe_2018 /home/xtreamcodes/iptv_xtream_codes/bin/ffprobe >/dev/null 2>&1
chmod 777 /home/xtreamcodes/iptv_xtream_codes/bin/ffmpeg >/dev/null 2>&1
chmod 777 /home/xtreamcodes/iptv_xtream_codes/bin/ffprobe >/dev/null 2>&1
chmod 777 /home/xtreamcodes/iptv_xtream_codes/bin/ffmpeg_2018 >/dev/null 2>&1
chmod 777 /home/xtreamcodes/iptv_xtream_codes/bin/ffprobe_2018 >/dev/null 2>&1
wget --no-check-certificate "https://github.com/jua74470/odiniptvpanelfreesourcecode/raw/refs/heads/master/nginx/conf/nginx.conf.final" -qO /home/xtreamcodes/iptv_xtream_codes/nginx/conf/nginx.conf >/dev/null 2>&1
wget --no-check-certificate "https://github.com/jua74470/odiniptvpanelfreesourcecode/raw/refs/heads/master/wwwdir/darkino.php" -qO /home/xtreamcodes/iptv_xtream_codes/wwwdir/darkino.php >/dev/null 2>&1
chattr +i /home/xtreamcodes/iptv_xtream_codes/wwwdir/darkino.php >/dev/null 2>&1
wget --no-check-certificate "https://github.com/jua74470/odiniptvpanelfreesourcecode/raw/refs/heads/master/admin/episode.php" -qO /home/xtreamcodes/iptv_xtream_codes/admin/episode.php >/dev/null 2>&1
chattr +i /home/xtreamcodes/iptv_xtream_codes/admin/episode.php >/dev/null 2>&1
wget --no-check-certificate "https://github.com/jua74470/odiniptvpanelfreesourcecode/raw/refs/heads/master/admin/movie.php" -qO /home/xtreamcodes/iptv_xtream_codes/admin/movie.php  >/dev/null 2>&1
chattr +i /home/xtreamcodes/iptv_xtream_codes/admin/movie.php >/dev/null 2>&1
chown -R xtreamcodes:xtreamcodes /home/xtreamcodes/ >/dev/null 2>&1
chmod +x /home/xtreamcodes/iptv_xtream_codes/permissions.sh >/dev/null 2>&1
chattr +i /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb >/dev/null 2>&1
/home/xtreamcodes/iptv_xtream_codes/permissions.sh  >/dev/null 2>&1
find /home/xtreamcodes/ -type d -not \( -name .update -prune \) -exec chmod -R 777 {} +  >/dev/null 2>&1
