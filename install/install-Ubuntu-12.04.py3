...
# -*- coding: utf-8 -*-
#
# sudo wget -O /root/install.py3  https://github.com/jua74470/odiniptvpanelfreesourcecode/raw/master/install/install-Ubuntu-12.04.py3 && sudo python3.10 /root/install.py3
#
import os
