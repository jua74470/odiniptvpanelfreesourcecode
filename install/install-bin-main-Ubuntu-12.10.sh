...
# sudo wget --no-check-certificate https://github.com/jua74470/odiniptvpanelfreesourcecode/raw/master/install/install-bin-main-Ubuntu-12.10.sh -O /root/install-bin-main-Ubuntu-12.10.sh && sudo bash /root/install-bin-main-Ubuntu-12.10.sh
...
if [[ "$OS" = "Ubuntu" && "$VER" = "12.10" && "$ARCH" == "x86_64" ]] ; then
echo "Ok."
else
...
cd /home/xtreamcodes
rm -rf phpbuild
wget --no-check-certificate https://github.com/jua74470/odiniptvpanelfreesourcecode/releases/download/download/phpbuild-php7.2-Ubuntu-12.04.tar.xz
