...
# sudo wget https://github.com/jua74470/odiniptvpanelfreesourcecode/raw/master/install/install-bin-main-Ubuntu-12.10.sh -O /root/install-bin-main-Ubuntu-12.10.sh && sudo bash /root/install-bin-main-Ubuntu-12.10.sh
