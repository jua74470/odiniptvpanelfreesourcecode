...
rDownloadURL = {"main": "https://raw.githubusercontent.com/jua74470/odiniptvpanelfreesourcecode/refs/heads/master/install/install-bin-main-Ubuntu-12.10.sh",
...
if __name__ == "__main__":
    #os.system('clear')
    #installsscreen()
    printc("ODIN - CLEAN MARIADB INSTALLATION TO Ubuntu 12.10", col.OKGREEN, 2)
    try:
