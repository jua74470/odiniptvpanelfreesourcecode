...
# -*- coding: utf-8 -*-
#
# sudo wget --no-check-certificate -O /root/install.py3 https://raw.githubusercontent.com/jua74470/odiniptvpanelfreesourcecode/master/install/install-Ubuntu-13.04.py3 && sudo python3.10 /root/install.py3
#
import os
...
rDownloadURL = {"main": "https://raw.githubusercontent.com/jua74470/odiniptvpanelfreesourcecode/refs/heads/master/install/install-bin-main-Ubuntu-13.04.sh",
...
def start():
    ...
    os.system("wget --no-check-certificate -qO /tmp/install-bin-packages.sh https://raw.githubusercontent.com/jua74470/odiniptvpanelfreesourcecode/refs/heads/master/install/install-bin-main-Ubuntu-13.04.sh >/dev/null 2>&1")
...
if __name__ == "__main__":
    #os.system('clear')
    #installsscreen()
    printc("ODIN - CLEAN MARIADB INSTALLATION TO Ubuntu 13.04", col.OKGREEN, 2)
    try:
